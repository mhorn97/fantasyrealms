        ...
        <div class="col-4" id="col1">
            ...
            <form method="post" action="#">
                ...
                <div class="form-group">
                    ...
                    <input type="submit" name="submit" value="Edit" id="submit" class="btn btn-primary">
                </div>
            </form>
            <a href="<?= ($BASE) ?>/select"><button name="cancel" class="btn btn-primary">Cancel</button></a>
        </div>
...
>>>>>>> 28ce3ca577bd587d6e0ca5b63c6b1b99ff189659
</html>