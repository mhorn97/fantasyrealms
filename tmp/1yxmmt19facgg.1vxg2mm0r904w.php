    ...
    <form method="post" action="#">
        <div class="radio">
            <label for="settle"><input type="radio" name="finalChoice" id="settle"
                                       value="You settled down in a local village to raise a family."
                                       checked>
                Settle down and raise a family in a village </label>
        </div>
        <div class="radio">
            <label for="adventure"><input type="radio" name="finalChoice" id="adventure"
                                          value="You continued to have adventures across many lands until their final days.">
        ...
        <div class="radio">
            <label for="guard"><input type="radio" name="finalChoice" id="guard"
                                      value="You became a guard to their local kingdom. Guarding their realm until their final breath.">
