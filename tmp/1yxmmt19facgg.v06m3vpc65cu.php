...
<form method="post" action="#">
    ...
    <input type="radio" name="choice3" id="answer1" value="answer1" checked><br>
    <label for="answer2"><?= ($answer2) ?></label>
    <input type="radio" name="choice3" id="answer2" value="answer2"><br>
    <label for="answer3"><?= ($answer3) ?></label>
    <input type="radio" name="choice3" id="answer3" value="answer3"><br>
